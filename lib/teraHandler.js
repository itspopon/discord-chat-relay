  ...
  teraToDiscordIPC() {
    ...
    this.dispatch.hook('S_CHAT', 2, (event) => {
      if (event.channel === 2 && event.authorName !== this.myName) {
        ...
        // @@@
        console.log(
          `[${U.getTimestamp()}][teraHandler.js] Channel: {`,
          event.channel,
          '} | Author: {',
          event.authorName,
          '} | Message: ',
    ...
    this.sysmsg.on('SMT_GUILD_MEMBER_LOGON', (params) => {
      ...
      console.log('this.onlineGuildies BEFORE: ', this.onlineGuildies);
      console.log('adding... {', params.UserName, '}');
      this.currOnlineGuildies.push(params.UserName);
      console.log('this.onlineGuildies AFTER: ', this.onlineGuildies);
    ...
    this.sysmsg.on('SMT_GUILD_MEMBER_LOGOUT', (params) => {
      ...
      console.log('this.onlineGuildies BEFORE: ', this.onlineGuildies);
      console.log('removing... {', params.UserName, '}');
    ...
    this.dispatch.hook('S_GUILD_INFO', 1, (event) => {
      console.log('@@@ RECEIVED Guild info: ', event);
      try {
    ...
    this.dispatch.hook('S_GUILD_MEMBER_LIST', 1, (event) => {
      console.log('@@@ RECEIVED Guild Member list: ', event);
