...
class TeraHandler {
  constructor(dispatch, config) {
    ...
    this.onlineGuildies = [];
    this.quests = [];
    this.questProgress = {}; // questName (string) => progress (string)
  ...
  teraToDiscordIPC() {
    ...
    this.dispatch.hook('S_UPDATE_GUILD_QUEST_STATUS', 1, (event) => {
      console.log('@@@ S_UPDATE_GUILD_QUEST_STATUS triggered');
      fs.writeFile(
    ...
    this.dispatch.hook('S_GUILD_QUEST_LIST', 1, (event) => {
      console.log('@@@ S_GUILD_QUEST_LIST triggered');
    ...
    this.dispatch.hook('S_GUILD_INFO', 1, (event) => {
      console.log('@@@ RECEIVED Guild info triggered');
      fs.writeFile(
    ...
    this.dispatch.hook('S_GUILD_MEMBER_LIST', 1, (event) => {
      console.log('@@@ S_GUILD_MEMBER_LIST triggered');
      fs.writeFile(
